...
const defaultProjects = [
  ...
  },
  {
    ...
    imageFit: "contain",
    type: "Laravel App",
    title: "JN Vehicle Booking System",
    description:
      "Aplikasi tempahan kenderaan dengan Google OAuth, kelulusan admin, assignment pemandu, laporan, dan audit log.",
    link: "https://github.com/tengodowncoder/vehicle-booking-system",
    details:
      "Project Summary\nJN Vehicle Booking System is a Laravel-based web application developed to digitize the vehicle booking workflow for official use. The system allows applicants to log in using a verified MOE/KPM Google account, submit vehicle booking requests, track booking status, and manage their own applications. Admin users can review requests, approve or reject bookings, assign vehicles and drivers, manage booking schedules, generate reports, and monitor system activity through audit logs.\n\nTech Stack\n• Laravel 12\n• PHP 8.2\n• Supabase PostgreSQL\n• Google OAuth / Laravel Socialite\n• Blade Template\n• Custom CSS, Vite, Tailwind-ready frontend setup\n• Laravel Mail / SMTP-ready reminder system\n• PHPUnit Feature Tests\n• Git and GitHub\n\nKey Features\n• Google login restricted to MOE/KPM domain\n• Super admin user approval workflow\n• Role-based access control: super_admin, admin, pemohon\n• Applicant vehicle booking form\n• Booking status tracking: pending, approved, rejected, cancelled, completed\n• Admin booking approval and rejection workflow\n• Vehicle and driver assignment\n• Vehicle conflict checking\n• Email reminder one day before booking date\n• Booking calendar\n• Monthly report and CSV export\n• Printable booking slip\n• User profile management\n• Audit log for important system actions\n• UAT documentation, deployment notes, backup guide, and demo presentation\n\nWorkflow\n1. User logs in using an approved MOE/KPM Google account.\n2. New user waits for super admin approval.\n3. Applicant submits a vehicle booking request.\n4. Admin reviews the booking.\n5. Admin assigns vehicle and driver.\n6. Admin approves or rejects the request.\n7. System sends reminder one day before the booking date.\n8. Admin marks the booking as completed after the trip.\n\nMy Role\n• Planned the full system workflow.\n• Built the Laravel application from scratch.\n• Designed database migrations and booking structure.\n• Integrated Supabase PostgreSQL.\n• Configured Google OAuth login.\n• Implemented role-based access control.\n• Developed applicant and admin modules.\n• Built booking approval, rejection, cancellation, and completion workflow.\n• Added email reminder automation using Laravel Artisan command.\n• Created audit logs and reporting features.\n• Wrote feature tests and prepared UAT documentation.\n• Managed GitHub repository and project backup.\n\nPortfolio Paragraph\nSaya membangunkan JN Vehicle Booking System menggunakan Laravel, Supabase PostgreSQL, dan Google OAuth untuk mendigitalkan proses tempahan kenderaan rasmi. Sistem ini menyokong login domain MOE/KPM, kelulusan pengguna oleh super admin, permohonan tempahan oleh pemohon, semakan admin, penetapan kenderaan dan pemandu, reminder sehari sebelum tempahan, laporan bulanan, export CSV, audit log, serta dokumentasi UAT. Projek ini memberi saya pengalaman membina sistem workflow sebenar dari kosong sehingga siap untuk demo dan portfolio.",
